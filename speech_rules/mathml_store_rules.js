...
cvox.MathmlStoreRules.initDefaultRules_ = function() {
  ...
  defineRule('mtext-variant', 'default.default',
      '[t] "começar"; [t] @mathvariant (pause:150);' +
          '[t] text() (pause:150); [t] "final"; ' +
  ...
  defineDefaultMathmlRule(
      'ms',
      '[t] "sequência de caracteres" (pitch:0.5, rate:0.5); [t] text()');
  ...
  defineRule(
      'mtd', 'default.short',
      '[t] "elemento"; [t] count(./preceding-sibling::mathml:mtd)+1;' +
...
cvox.MathmlStoreRules.initSpecializationRules_ = function() {
  ...
  defineRule(
      ...
      '[n] ./*[1]; [t] "praça" (pitch:0.35); [p] (pause:300)',
  ...
  defineRule(
      ...
      '[n] ./*[1]; [t] "sub"; [n] ./*[2] (pitch:-0.35);' +
          '[p] (pause:300); [t] "praça" (pitch:0.35); [p] (pause:400)',
  ...
  defineRule(
      ...
      '[n] ./*[1]/*[1]/*[1]; [t] "praça" (pitch:0.35); [p] (pause:300)',
...
cvox.MathmlStoreRules.initSemanticRules_ = function() {
  ...
  defineRule(
      ...
      '[n] children/*[1]; [t] "o postfix"; [n] text() (pause 300)',
      'self::postfixop');
  ...
  defineRule(
      ...
      '[p] (pause:100); [t] "abra"; [n] children/*[1]; [p] (pause:200);' +
      '[t] "fechar"',
  ...
  defineRule(
    ...
    '[n] children/*[1]; [t] "de"; [n] children/*[2]; [t] "para";' +
    '[n] children/*[3]', 'self::limboth');

  defineRule(
    'sum-only', 'default.default',
    '[n] children/*[1]; [p] (pause 100); [t] "sobre"; [n] children/*[2];' +
    '[p] (pause 250);',
    'self::limboth', 'self::limboth[@role="sum"]');

  defineRule(
    'limlower', 'default.default',
    '[n] children/*[1]; [t] "sobre"; [n] children/*[2];', 'self::limlower');
  ...
  defineRule(
      'square', 'default.default',
      '[n] children/*[1]; [t] "praça" (pitch:0.35); [p] (pause:300)',
